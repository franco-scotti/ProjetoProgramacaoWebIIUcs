...
<section class="hero-panel">
    <div class="hero-copy">
        ...
        <div class="hero-actions">
            <a href="<?= BASE_URL ?>/views/listagem/lista_produtos.php" class="btn btn-primary btn-lg">Ver catalogo</a>
            ...
            <?php if ($produtosDestaque) { ?>
                <?php foreach ($produtosDestaque as $produto) { ?>
                    <div class="feature-card">
                        ...
                        <a href="<?= BASE_URL ?>/views/detalhes/mostra_produto.php?id=<?php echo $produto->getId(); ?>">Abrir cadastro</a>
                    </div>
                <?php } ?>
            <?php } else { ?>
...
<section class="commerce-banner">
    ...
    <div class="banner-links">
        <a href="<?= BASE_URL ?>/views/listagem/lista_produtos.php">Catalogo completo</a>
