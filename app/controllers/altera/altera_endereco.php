...
if (!empty(camposObrigatorios($campos, $dados))) {
    header("Location: " . BASE_URL . "/views/cadastro/form_endereco.php?id=" . $id . "&erro=campos_obrigatorios");
    exit;
}

if (($fornecedorId === "" && $clienteId === "") || ($fornecedorId !== "" && $clienteId !== "")) {
    header("Location: " . BASE_URL . "/views/altera/modifica_endereco.php?id=" . $id . "&erro=vinculo_invalido");
    exit;
}
...
if ($fornecedorId !== "") {
    ...
    if ($fornecedor === null) {
        header("Location: " . BASE_URL . "/views/altera/modifica_endereco.php?id=" . $id . "&erro=fornecedor_invalido");
        exit;
    }
...
if ($clienteId !== "") {
    ...
    if ($cliente === null) {
        header("Location: " . BASE_URL . "/views/altera/modifica_endereco.php?id=" . $id . "&erro=cliente_invalido");
        exit;
    }
...
try {
    ...
    header("Location: " . BASE_URL . "/views/altera/modifica_endereco.php?id=" . $id . "&erro=erro_alteracao");
    exit;
}
