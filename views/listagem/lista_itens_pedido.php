...
if($itens) {
    ...
    echo "<tr><th>PedidoId</th><th>ProdutoId</th><th>Quantidade</th><th>Preco</th><th>Acoes</th></tr>";
    ...
    foreach ($itens as $item) {
        ...
        echo "<a href='" . BASE_URL . "/views/cadastro/form_item_pedido.php?id={$item->getId()}' class='btn btn-info left-margin'><span class='glyphicon glyphicon-edit'></span> Altera</a>";
...
echo "<a href='" . BASE_URL . "/views/cadastro/form_item_pedido.php' class='btn btn-primary left-margin'>Novo</a>";
